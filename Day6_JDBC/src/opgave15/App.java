        ...
        while (true) {
            try {
                ...
                if (aarstal.isEmpty() || rytterinitialer.isEmpty() || placering.isEmpty()) {
                    ...
                    String query = "insert into placering values (?, ?, ?);";
                    PreparedStatement preparedStatement = connection.prepareStatement(query);
                    preparedStatement.clearParameters();
                    preparedStatement.setInt(1, Integer.parseInt(aarstal));
                    preparedStatement.setString(2, rytterinitialer);
                    if (placering.equalsIgnoreCase("null")) {
                        preparedStatement.setNull(3, Types.INTEGER);
                    } else {
                        preparedStatement.setInt(3, Integer.parseInt(placering));
                    }
